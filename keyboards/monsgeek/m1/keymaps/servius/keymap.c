...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_B] = LAYOUT_all( /* Base */
      ...
      MO(WIN_W), KC_LALT, KC_LGUI,                   KC_SPC,                             MO(WIN_W), MO(WIN_FN), KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [WIN_W] = LAYOUT_all( /* Base */
        ...
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, _______, _______, _______, _______,          _______,
